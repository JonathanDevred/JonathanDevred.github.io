    ...
    return (
        ...
        <Header title="A PROPOS DE MOI"/>
            ...
            <main className="general-main">
                ...
                <h2 className="general-subtitle">Qui suis-je ?</h2>
                ...
                <section className="general-section">
                <h2 className="general-subtitle">Pourquoi le dévéloppement web ?</h2>
                ...
                <section className="general-section">
                <h2 className="general-subtitle"> Quelle stack technique ?</h2>
                ...
                <section className="general-section">
                <h2 className="general-subtitle">Et pour la suite ?</h2>
